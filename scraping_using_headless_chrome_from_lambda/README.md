...
$ rm chromedriver.zip
$ zip -r zip/ruby-serverless-chrome-bin.zip ./bin
```

### Zipをアップロード
- Layerの名称は`ruby-serverless-chrome-bin`
- アップロードに3-5分ぐらいはかかると思います
- [参考](https://hacknote.jp/archives/49980/)

```
$ make upload-layer
```
または、`Lambda > Layers > レイヤー作成`でZIPファイルをアップロード
